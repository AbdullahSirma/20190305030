...
public class UpdateEmployee extends JFrame {
    ...
    public UpdateEmployee(Employee employee){
        ...
        for(Department d:list){
            ...
            if(employee.getDepartmentId() == d.getId()){
                cmbDepartments.setSelectedItem(d.getDepartmentName());
            }
        }
        txtFirstName.setText(employee.getFirstName());
        txtLastName.setText(employee.getLastName());
        txtBirthDate.setText(employee.getBirthDate().toString());
        ...
        btnUpdate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String SQL = "UPDATE Employees SET DepartmentId = ?," +
                        " FirstName = ?, " +
                        " LastName = ?, " +
                        " BirthDate = ?," +
                        " Salary = ? " +
                ...
                try (Connection con = DriverManager.getConnection(connectionUrl);
                    ...
                    if(result == 1){
                        JOptionPane.showMessageDialog(btnUpdate,"Department updated successfully");
                    }
                }
                // Handle any errors that may have occurred.
                catch (SQLException ex) {
